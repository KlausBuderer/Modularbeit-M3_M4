...
<div class="container-fluid overflow-hidden" id="body">
  <div class="row vh-100 overflow-auto">
    <div class="col-12 col-md-1 col-sm-12 col-xl-2 px-sm-12 px-0 d-flex sticky-bottom ">
      <div id="sidebar" class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
        <br>
        <br>
        ...
        <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-md-grow-0 flex-grow-1 mb-md-auto mb-0 justify-content-center align-items-center align-items-sm-start" id="menu">
          ...
          <li class="nav-item sidebar-button">
            <a class="nav-link text" href="/includes/kinder_uebersicht_template.php">
              ...
              </svg> <span class="ms-1 d-none d-xl-inline"> Übersicht</span>
            </a>
          </li>

          <li class="nav-item sidebar-button">
            <a class="nav-link text" href="/includes/mathe_uebersicht_template.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calculator" viewBox="0 0 16 16">
                <path d="M12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h8zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4z" />
                <path d="M4 2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-2zm0 4a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm3-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm3-6a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-4z" />
              </svg> <span class="ms-1 d-none d-xl-inline"> Mathematik</span>
            </a>
          </li>

          <li class="nav-item sidebar-button">
            <a class="nav-link text" href="/includes/realien_uebersicht_template.php">
              ...
              </svg> <span class="ms-1 d-none d-xl-inline"> Realien</span>
            </a>
          </li>

          <li class="nav-item sidebar-button">
            <a class="nav-link text" data-bs-toggle="tooltip" data-bs-placement="right" title="In diesem Release noch nicht implementiert" data-bs-content="And here's some amazing content. It's very engaging. Right?" href="/includes/deutsch_uebersicht_template.php">
          ...
          <li class="nav-item sidebar-button">
            <a class="nav-link text" href="/includes/englisch_uebersicht_template.php">
              ...
              </svg> <span class="ms-1 d-none d-xl-inline">Englisch</span>
            </a>
          </li>

          <li class="nav-item sidebar-button">
            <a class="nav-link text" href="/features/kind/kinder_guthaben/guthaben_controller.php">
          ...
          <!-- Farbschema Modal -->
          <li class="nav-item sidebar-button">
            <button class="nav-link text" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-credit-card-2-front" viewBox="0 0 16 16">
                <path d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z" />
                <path d="M2 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5z" />

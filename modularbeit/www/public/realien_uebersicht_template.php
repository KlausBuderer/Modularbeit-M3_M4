...
<div class="album py-5 bs-wight">
    <div class="container">
        ...
        <!-- Titel -->
        <h1 id="titel" class="text-center fw-lighter display-2">Realien</h1>
        <hr>
        <!-- Card Hauptstädte und länder -->
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body" id="card1">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <button type="submit" name="hauptstaedte_laender" class="btn btn-sm btn-outline-secondary card-button">Starten</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Card Schweiz -->
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <img src="images/realienschweiz.jpg" style="height: 18rem;" class="card-img-top">
                        ...
                        <div class="card-body" id="card2">
                            ...
                            <div class="btn-group">
                                <button type="submit" name="schweiz" class="btn btn-sm btn-outline-secondary card-button">Starten</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Card Tiere -->
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <img src="images/realientiere.jpg" style="height: 18rem;" class="card-img-top">
                        ...
                        <div class="card-body" id="card3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <button type="submit" name="tiere" class="btn btn-sm btn-outline-secondary card-button">Starten</button>
                                </div>
                            </div>
                        </div>
                    </div>
